...
import Pages.MorningTimerPage;
import java.time.LocalTime;

public class MorningTimerTest {
    private WebDriver driver;
    private MorningTimerPage morningTimerPage;
    ...
    public void setup() {
        ...
        morningTimerPage = new MorningTimerPage(driver);

        // Calculate the time difference for the desired execution time
        LocalTime currentTime = LocalTime.now();
        LocalTime targetTime = LocalTime.of(17, 49);
    ...
    @Test
    public void testMorningTimer() {
        morningTimerPage.clickSelectCheckbox();
        morningTimerPage.clickEnableButton();
    }
